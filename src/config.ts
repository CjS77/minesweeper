...
export function loadConfig(env: Env = process.env): Config {
  ...
  const candidate = {
    ...
    planningAgent: readString(env, "MINESWEEPER_PLANNING_AGENT", "opus"),
    reviewAgent: readString(env, "MINESWEEPER_REVIEW_AGENT", "sonnet"),
    executionAgent: readString(env, "MINESWEEPER_EXECUTION_AGENT", "opus"),
